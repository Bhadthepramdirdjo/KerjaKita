...
<body class="text-keel-black h-screen flex overflow-hidden">
    ...
    <main class="flex-1 flex flex-col h-screen relative w-full">
        ...
        <div class="w-full px-6 pt-8 pb-4 flex items-center gap-4 ml-20">
            <div class="flex-1">
                <h1 class="text-3xl font-bold text-keel-black">Buat Lowongan Pekerjaan</h1>
                <p class="text-base text-gray-600 mt-1">Isi formulir di bawah untuk membuka lowongan baru</p>
            </div>
        </div>
