...
<body class="text-keel-black h-screen flex overflow-hidden">
    ...
    <div id="speed-dial-container" class="fixed top-6 left-6 z-50 flex flex-col items-center gap-4">
        ...
        <div id="speed-dial-menu" class="flex flex-col gap-3 items-center opacity-0 -translate-y-4 scale-90 pointer-events-none transition-all duration-300 ease-out origin-top">
            ...
            <!-- Profil -->
            <a href="{{ route('pemberi-kerja.profil') }}" class="w-12 h-12 rounded-full bg-keel-black text-white shadow-lg flex items-center justify-center hover:bg-seafoam-bloom hover:text-white transition-all duration-200 transform hover:scale-110" title="Profil">
    ...
    <!-- Main Content -->
    <main class="flex-1 flex flex-col h-screen relative w-full overflow-y-auto">
